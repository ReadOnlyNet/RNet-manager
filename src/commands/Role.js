...
class Role extends Command {
	constructor(...args) {
		...
		this.usage = [
			'role ROM™ Accomplices',
			'role ROM™ Regulars, Accomplices',
			'role ROM™ Members, -Newbies',
			'role ROM™ +Members, -Newbies (prevent toggling)',
			'role ROM™ Regulars, Accomplices, The Hammer, Overseers',
			'role add ROM™ Regulars (no -/+)',
			'role remove ROM™ Regulars (no -/+)',
			'role toggle ROM™ Regulars (no -/+)',
			'role all Humans',
			'role all -Humans',
			'role bots Boats',
			'role bots -Humans',
